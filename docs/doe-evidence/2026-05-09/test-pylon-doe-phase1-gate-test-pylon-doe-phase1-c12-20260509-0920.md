...
Run: `test-hank-doe-phase1-c12-20260509-0920`
...
|---|---:|---:|---|
| multi-hop complete evidence coverage on low-F1 rows | >=4 | 3 | FAIL |
| open-domain any evidence coverage on low-F1 rows | >=5 | 5 | PASS |
| temporal raw F1 floor on same stratified shape | >=0.6 | 0.7013 | PASS |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| single-hop | 15 | 0.5367 | 0.5986 | 9 | 6 | 6 | 2 | 0 |
| multi-hop | 10 | 0.5827 | 0.5827 | 7 | 7 | 3 | 1 | 0 |
...
|---|---|---:|---:|---:|---:|---:|---:|---|---|---|
| conv-30:3 | multi-hop | 0.4286 | 0.4286 | 4/4 | 0 | 0 | 0 | raw_message_fts | evidence-reached-reader | no |
| conv-42:1 | multi-hop | 0.6667 | 0.6667 | 7/7 | 1 | 1 | 0 | raw_message_fts | evidence-reached-reader | no |
| conv-43:0 | multi-hop | 0.5 | 0.5 | 2/3 | 2 | 2 | 0 | open_domain_raw | evidence-reached-reader | no |
| conv-44:2 | multi-hop | 0 | 0 | 3/4 | 1 | 1 | 0 | raw_message_fts | evidence-reached-reader | no |
...
| conv-48:15 | single-hop | 0.5 | 1 | 3/3 | 0 | 0 | 0 | raw_message_fts | evidence-reached-reader | no |
