...
interface SecretRule {
  ...
  description: string;
  pattern: RegExp;
  /** Min entropy of the matched value (base36). 0 = no entropy check. */
  minEntropy?: number;
}
 ...
 */
export function isSafeForSharedVisibility(content: string): boolean {
 ...
 */
export function requiresScan(visibility: string): boolean {
