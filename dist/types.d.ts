...
export interface EntityBridgeRecallDiagnostics {
    attempted: boolean;
    applied: boolean;
    reason?: 'disabled' | 'tables_missing' | 'no_seeds' | 'empty_graph' | 'no_candidates' | 'failed';
...
export interface IndexerConfig {
    ...
    recentConversationCooldownMs?: number;
 ...
 */
export type TrimTelemetryPath = 'assemble.normal' | 'assemble.toolLoop' | 'assemble.subagent' | 'reshape' | 'compact.nuclear' | 'compact.history' | 'compact.history2' | 'afterTurn.secondary' | 'warmstart';
/**
