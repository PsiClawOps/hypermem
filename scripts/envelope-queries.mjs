 ...
 * 
 * Usage:
 *   node scripts/envelope-queries.mjs --agent my-agent --query pairs --window 2000
 *   node scripts/envelope-queries.mjs --all --query summary
 *   node scripts/envelope-queries.mjs --agent my-agent --query safe-candidates
 *   node scripts/envelope-queries.mjs --agent my-agent --query unmatched
 *   node scripts/envelope-queries.mjs --all --query fleet-summary
 *   node scripts/envelope-queries.mjs --agent my-agent --query delete-wave1 [--apply]
 * 
 * Queries:
